                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover align-middle" id="pointstable">
                        ...
                        <tbody>
                                    ...
                                    <td>
                                        @if ($p->image)
                                            <img src="{{ asset('storage/images/' . $p->image) }}" alt="{{ $p->name }}"
                                                class="img-thumbnail-table" title="{{ $p->image }}">
                                        @else
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="text-center text-muted py-4">No point data available. Please
                                        add some points.</td>
                                </tr>
                            @endforelse
                        </tbody>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover align-middle" id="polylinestable">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="text-center text-muted py-4">No polyline data available.
                                        Please add some polylines.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover align-middle" id="polygonstable">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="text-center text-muted py-4">No polygon data available. Please
                                        add some polygons.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
